...
from .models import Jobs,Jobbid,ProfileJob

class ProfileJobadmin(admin.ModelAdmin):
    list_display = ('name','aboutyou','profileimage','location','address','customer_id','client_token', )

    fieldsets = (
        (None, {
            'fields': (
                'name', 'aboutyou', 'profileimage', 'location', 'address','customer_id','client_token',
...
admin.site.register(ProfileJob,ProfileJobadmin)
