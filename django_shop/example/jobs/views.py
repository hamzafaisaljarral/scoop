...
from .models import Jobs, JobPluginModel
from .forms import JobBaseForm, JobAjaxForm
...
class JobFormView(FormView):
    ...
    def get_initial(self):
        ...
        initial = super(JobFormView, self).get_initial()
...
class JobFormAjaxView(FormView):
    ...
    def form_valid(self, form):
        ...
        return super(JobFormAjaxView, self).form_valid(form)
