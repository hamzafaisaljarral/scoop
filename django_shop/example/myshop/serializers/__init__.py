...
if settings.SHOP_TUTORIAL in ['commodity', 'i18n_commodity']:
    ...
    from .polymorphic import (SmartCardSerializer, SmartPhoneSerializer,ScoopSerializer, AddSmartPhoneToCartSerializer)

    __all__.extend(['ScoopSerializer','SmartCardSerializer', 'SmartPhoneSerializer', 'AddSmartPhoneToCartSerializer'])
