...
BRAINTREE_MERCHANT = 'bmpnzd99n53ypq5w'
BRAINTREE_PUBLIC_KEY = 'ggkpz86wxpbddtch'
BRAINTREE_PRIVATE_KEY = 'ec56ac1ac08cb8b810093cf07d67bd49'

EASY_MAPS_GOOGLE_KEY = 'AIzaSyATvnfTogfVDaRcFhlCOCFQ2bzqugzHAFQ'
...
CMS_TEMPLATES = [
    ...
    ('myshop/pages/Home.html', _("Home Page")),
    ('myshop/pages/List-view.html', _("list_view")),# Home page of my new template
    ('myshop/pages/Blog-listing.html', _("Blog_list")),
    ('myshop/pages/Profile.html', _("profile")),
    ('myshop/pages/Jobslist.html', _("Joblist")),
    ('myshop/pages/addjob.html', _("addjobs")),
...
CMS_PLACEHOLDER_CONF = {
    ...
    'Main Content': {
        'plugins': ['BootstrapContainerPlugin', 'BootstrapJumbotronPlugin','ContactPlugin','BlogPlugin',],
        'parent_classes': {
            'BootstrapContainerPlugin': None,
            'BootstrapJumbotronPlugin': None,
...
CMSPLUGIN_CASCADE_PLUGINS = [
    ...
    'shop.cascade',
    'contacts.cms_plugins',
    'cmsplugin_cascade.bootstrap3',
    'aldryn_forms.cms_plugins',
...
CMSPLUGIN_CASCADE = {
    ...
    'plugins_with_extra_render_templates': {
        'CustomSnippetPlugin': [
            ...
            ('myshop/catalog/manufacturer-filter.html', _("Top Seller")),
        ],
        'ShopAddToCartPlugin': [
            (None, _("Default")),
...
SHOP_STRIPE = {
    ...
    'APIKEY': 'sk_test_xUdHLeFasmOUDvmke 4DHGRDP',
...
if DEBUG:
    ...
    BT_MERCHANT_ID='bmpnzd99n53ypq5w'
    BT_PUBLIC_KEY='ggkpz86wxpbddtch'
    BT_PRIVATE_KEY='ec56ac1ac08cb8b810093cf07d67bd49'
else:
    # live keys
