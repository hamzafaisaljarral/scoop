...
from .models import HirePluginModel
from .forms import HireAjaxForm



class HirePlugin(CMSPluginBase):
    model = HirePluginModel
    name = _("Blog Form")
    ...
    def render(self, context, instance, placeholder):
        ...
        form = HireAjaxForm(initial={'referer': path})
...
plugin_pool.register_plugin(HirePlugin)
