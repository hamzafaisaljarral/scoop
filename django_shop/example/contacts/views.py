...
from .models import Contact,ContactPluginModel
...
class ContactDisplay(ListView):
    model = ContactPluginModel
    Template_name = 'contacts/displaycomment.html'

    def get_queryset(self):
        return ContactPluginModel.objects.all()
